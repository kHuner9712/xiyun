...
**也可直接执行 SQL**：`docs/sql/yunxi-init-activity-demo.sql`
...
**也可直接执行 SQL**：`docs/sql/yunxi-init-feedback-demo.sql`
...
**也可直接执行 SQL**：`docs/sql/yunxi-init-config.sql`
...
| 2 | 插入自定义配置项 | SQL | `docs/sql/yunxi-init-config.sql` |
| 3 | 插入活动演示数据 | SQL | `docs/sql/yunxi-init-activity-demo.sql` |
| 4 | 插入妈妈说演示数据 | SQL | `docs/sql/yunxi-init-feedback-demo.sql` |
