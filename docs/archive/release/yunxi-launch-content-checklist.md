...
('孕期营养课堂', '', 'classroom', 'pregnancy', '专业营养师讲解孕期饮食搭配', '线上直播', UNIX_TIMESTAMP(), UNIX_TIMESTAMP()+86400*30, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()+86400*25, 50, 1, 0.00, '孕禧客服', '{{CONTACT_PHONE}}', 1, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
('产后修复沙龙', '', 'salon', 'postpartum', '产后身体恢复指导', '孕禧体验中心', UNIX_TIMESTAMP()+86400*3, UNIX_TIMESTAMP()+86400*33, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()+86400*28, 20, 1, 0.00, '孕禧客服', '{{CONTACT_PHONE}}', 1, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
('备孕优生课堂', '', 'classroom', 'prepare', '备孕注意事项与优生优育知识', '线上直播', UNIX_TIMESTAMP()+86400*5, UNIX_TIMESTAMP()+86400*35, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()+86400*30, 100, 1, 0.00, '孕禧客服', '{{CONTACT_PHONE}}', 1, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
('母婴好物签到打卡', '', 'checkin', 'all', '每日签到领积分', '线上', UNIX_TIMESTAMP(), UNIX_TIMESTAMP()+86400*90, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()+86400*85, 0, 1, 0.00, '孕禧客服', '{{CONTACT_PHONE}}', 1, 0, UNIX_TIMESTAMP(), UNIX_TIMESTAMP());
```
...
> 以下 SQL 也可通过执行 `docs/sql/yunxi-init-config.sql` 完成（已做幂等处理，可重复执行）。
